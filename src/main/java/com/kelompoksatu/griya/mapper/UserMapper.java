...
public interface UserMapper {
  ...
  @Mapping(target = "companyAddress", source = "profile.companyAddress")
  @Mapping(target = "companyCity", source = "profile.companyCity")
  @Mapping(target = "companyProvince", source = "profile.companyProvince")
  @Mapping(target = "companyPostalCode", source = "profile.companyPostalCode")
  @Mapping(target = "companyDistrict", source = "profile.companyDistrict")
  @Mapping(target = "companySubdistrict", source = "profile.companySubdistrict")
