...
public class DeveloperController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse<DeveloperResponse>> createDeveloper(@Valid @RequestBody CreateDeveloperRequest request) {
        try {
            DeveloperResponse developer = developerService.createDeveloper(request);
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    true,
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    false,
                    "Failed to create developer: " + e.getMessage(),
                    null
            );
    ...
    public ResponseEntity<ApiResponse<List<DeveloperResponse>>> getAllDevelopers() {
        try {
            ...
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    true,
            ...
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    false,
                    "Failed to retrieve developers: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<DeveloperResponse>> getDeveloperById(@PathVariable Integer id) {
        try {
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    false,
                    "Failed to retrieve developer: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<DeveloperResponse>> getDeveloperByCompanyCode(@PathVariable String companyCode) {
        try {
            Optional<DeveloperResponse> developer = developerService.getDeveloperByCompanyCode(companyCode);
            if (developer.isPresent()) {
                ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                        true,
                        "Developer retrieved successfully",
                ...
                ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                        false,
                        "Developer not found with company code: " + companyCode,
                        null
                );
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
            }
    ...
    public ResponseEntity<ApiResponse<List<DeveloperResponse>>> getDevelopersByStatus(@PathVariable String status) {
        try {
            Developer.DeveloperStatus developerStatus = Developer.DeveloperStatus.valueOf(status.toUpperCase());
            List<DeveloperResponse> developers = developerService.getDevelopersByStatus(developerStatus);
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    true,
                    "Developers with status " + status + " retrieved successfully",
                    developers
            );
            return ResponseEntity.ok(response);
        } catch (IllegalArgumentException e) {
    ...
    public ResponseEntity<ApiResponse<List<DeveloperResponse>>> getDevelopersBySpecialization(@PathVariable String specialization) {
        try {
            Developer.Specialization spec = Developer.Specialization.valueOf(specialization.toUpperCase());
    ...
    public ResponseEntity<ApiResponse<List<DeveloperResponse>>> getDevelopersByCity(@PathVariable String city) {
        try {
            List<DeveloperResponse> developers = developerService.getDevelopersByCity(city);
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    true,
                    "Developers in " + city + " retrieved successfully",
                    developers
            );
            return ResponseEntity.ok(response);
        } catch (Exception e) {
    ...
    public ResponseEntity<ApiResponse<List<DeveloperResponse>>> getDevelopersByProvince(@PathVariable String province) {
        try {
            List<DeveloperResponse> developers = developerService.getDevelopersByProvince(province);
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    true,
                    "Developers in " + province + " retrieved successfully",
                    developers
            );
            return ResponseEntity.ok(response);
        } catch (Exception e) {
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<ApiResponse<List<DeveloperResponse>>> searchDevelopers(@RequestParam String companyName) {
        try {
            List<DeveloperResponse> developers = developerService.searchDevelopersByCompanyName(companyName);
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    true,
                    "Search results for '" + companyName + "' retrieved successfully",
                    developers
            );
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            ApiResponse<List<DeveloperResponse>> response = new ApiResponse<>(
                    false,
                    "Failed to search developers: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<DeveloperResponse>> updateDeveloperStatus(
        ...
        try {
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    true,
                    "Developer status updated successfully",
                    developer
            );
            return ResponseEntity.ok(response);
        } catch (IllegalArgumentException e) {
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    false,
                    "Failed to update developer status: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<DeveloperResponse>> verifyDeveloper(
        ...
        try {
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    false,
                    "Failed to verify developer: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<DeveloperResponse>> updatePartnershipStatus(
        ...
        try {
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    true,
                    "Developer partnership status updated successfully",
                    developer
            );
            return ResponseEntity.ok(response);
        } catch (IllegalArgumentException e) {
            ...
            ApiResponse<DeveloperResponse> response = new ApiResponse<>(
                    false,
                    "Failed to update partnership status: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteDeveloper(@PathVariable Integer id) {
        try {
            ...
            ApiResponse<Void> response = new ApiResponse<>(
                    false,
                    "Failed to delete developer: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<Boolean>> checkCompanyCodeExists(@PathVariable String companyCode) {
        try {
            boolean exists = developerService.existsByCompanyCode(companyCode);
            ApiResponse<Boolean> response = new ApiResponse<>(
                    true,
                    "Company code existence check completed",
                    exists
            );
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            ApiResponse<Boolean> response = new ApiResponse<>(
                    false,
                    "Failed to check company code existence: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    ...
    public ResponseEntity<ApiResponse<Boolean>> checkEmailExists(@PathVariable String email) {
        try {
            ...
            ApiResponse<Boolean> response = new ApiResponse<>(
                    false,
                    "Failed to check email existence: " + e.getMessage(),
                    null
            );
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
