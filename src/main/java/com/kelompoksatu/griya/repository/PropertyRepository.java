...
public interface PropertyRepository extends JpaRepository<Property, Integer> {
    ...
    List<Property> findByLandAreaRange(@Param("minArea") BigDecimal minArea, @Param("maxArea") BigDecimal maxArea);

    /**
     * Find properties by building area range
     */
    @Query("SELECT p FROM Property p WHERE p.buildingArea BETWEEN :minArea AND :maxArea")
    List<Property> findByBuildingAreaRange(@Param("minArea") BigDecimal minArea, @Param("maxArea") BigDecimal maxArea);
    ...
    List<Property> findByAvailabilityDateRange(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);

    /**
     * Find properties by year built range
     */
    @Query("SELECT p FROM Property p WHERE p.yearBuilt BETWEEN :startYear AND :endYear")
    List<Property> findByYearBuiltRange(@Param("startYear") Integer startYear, @Param("endYear") Integer endYear);
    ...
    List<Property> findByCriteria(@Param("propertyType") Property.PropertyType propertyType,
