...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    void updateLastLoginAt(@Param("userId") Integer userId, @Param("loginTime") LocalDateTime loginTime);
    ...
    void updateFailedLoginAttempts(@Param("userId") Integer userId, @Param("attempts") Integer attempts);
    ...
    void verifyEmail(@Param("userId") Integer userId, @Param("verificationTime") LocalDateTime verificationTime);
