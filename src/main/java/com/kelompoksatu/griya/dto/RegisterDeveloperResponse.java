...
@Schema(
    description =
        "Response object containing both user account and developer profile information after successful registration")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class RegisterDeveloperResponse {
  ...
  @Schema(
      ...
      example = "Leading property developer specializing in residential projects")
