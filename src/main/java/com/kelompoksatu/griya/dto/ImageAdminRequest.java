...
public class ImageAdminRequest {
    ...
    @Schema(description = "Type of the image (EXTERIOR, INTERIOR, FLOOR_PLAN, SITE_PLAN, LOCATION, AMENITIES, 360_VIEW)", example = "EXTERIOR")
    private ImageType imageType;

    @Schema(description = "Category of the image (MAIN, GALLERY, THUMBNAIL)", example = "GALLERY")
    private ImageCategory imageCategory;

    @Schema(description = "Optional caption or description for the image", example = "Tampak depan rumah")
