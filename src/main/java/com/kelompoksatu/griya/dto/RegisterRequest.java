...
/**
 * DTO for comprehensive user registration request Includes both user account and profile
 * information
 */
@Getter
@Setter
...
public class RegisterRequest {
  ...
  @NotNull(message = "Monthly income is required") @DecimalMin(value = "0.0", inclusive = false, message = "Monthly income must be greater than 0")
