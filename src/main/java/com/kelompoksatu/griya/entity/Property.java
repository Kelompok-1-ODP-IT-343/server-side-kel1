...
public class Property {
    ...
    public enum PropertyType {
        RUMAH, APARTEMEN, RUKO, TANAH, TOWNHOUSE, VILLA
    }

    public enum ListingType {
        PRIMARY, SECONDARY // Primary dari developer, Secondary dari individu
    }

    public enum CertificateType {
        SHM, HGB, HGU, HP, GIRIK, PETOK_D
    }

    public enum PropertyStatus {
        AVAILABLE, RESERVED, SOLD, OFF_MARKET, UNDER_CONSTRUCTION
    }
    ...
    public Property(String propertyCode, Integer developerId, PropertyType propertyType,
                   ListingType listingType, String title, String description,
                   String address, String city, String province, String postalCode,
                   String district, String village, BigDecimal landArea,
                   BigDecimal buildingArea, Integer bedrooms, Integer bathrooms,
                   BigDecimal price, BigDecimal pricePerSqm, CertificateType certificateType,
                   String slug) {
