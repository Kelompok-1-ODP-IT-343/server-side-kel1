...
public class KprApplication {
    ...
    public enum ApplicationPurpose {
        PRIMARY_RESIDENCE, INVESTMENT, BUSINESS
    }

    public enum ApplicationStatus {
        SUBMITTED, DOCUMENT_VERIFICATION, PROPERTY_APPRAISAL, CREDIT_ANALYSIS,
        APPROVAL_PENDING, APPROVED, REJECTED, CANCELLED, DISBURSED
    }
}